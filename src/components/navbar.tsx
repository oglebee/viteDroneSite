  ...
  <ul className="navbar-nav">
    ...
    <li className="nav-item">
      ...
      <svg
        ...
        >
      <g className="fa-group">
      <g id="bolt1" clip-path="url(#clip0_0_1)">
      <path
        fill="currentColor"
      ...
      <g className="fa-group">
      <line className="fa-secondary" x1="268.565" y1="197.826" x2="157.565" y2="279.826" stroke="currentColor" stroke-width="12"/>
      <line className="fa-secondary" x1="163.571" y1="279.047" x2="4.57074" y2="105.047" stroke="currentColor" stroke-width="12"/>
      <path
        fill="currentColor"
